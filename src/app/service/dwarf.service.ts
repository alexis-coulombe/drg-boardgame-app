...
export class DwarfService {
  private dwarves: Dwarf[] = [
    new Dwarf('Driller', 'assets/images/driller_banner.jpg', 0, 0, 0, []),
    new Dwarf('Engineer', 'assets/images/engineer_banner.jpg', 0, 0, 0, []),
    new Dwarf('Gunner', 'assets/images/gunner_banner.jpg', 0, 0, 0, []),
    new Dwarf('Scout', 'assets/images/scout_banner.jpg', 0, 0, 0, []),
  ];
